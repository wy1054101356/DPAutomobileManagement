        ...
        <div class="container padding-big-top padding-big-bottom">
            <div class="line-big">
                <div class="xl12 xs9 xm9 xb9">
                    <c:if test="${empty itmstrs}"><
                        div class="text-large text-center margin-big-bottom">暂无任何信息！</div>
                    </c:if>
                    <c:if test="${!empty itmstrs}">
                    <div class="text-large text-center margin-big-bottom">产品项目信息</div>
                    <table class="table table-hover table-bordered" id="tal">
                        <tr style="background-color: #cacaca ">
                            <td>项目编号</td><td>父项目编号</td><td>项目名称</td><td>顺序号</td><td>使用数量</td><td>供应商编号</td>
                        </tr>
