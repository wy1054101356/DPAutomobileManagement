 ...
 * @author wy105
 */
@WebServlet(name = "DPShowTreeAll", urlPatterns = {"/Admin/DPShowTreeAll"})
public class DPShowTreeAll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/admin/DPShowTreeAll.jsp").forward(request, response);
