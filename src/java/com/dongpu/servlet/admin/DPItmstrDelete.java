 ...
 * @author wy105
 */
@WebServlet(name = "DPItmstrDelete", urlPatterns = {"/Admin/DPItmstrDelete"})
public class DPItmstrDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DaoFactory.GetItmstrDaoImp().DeleteItmstr(itmId);
