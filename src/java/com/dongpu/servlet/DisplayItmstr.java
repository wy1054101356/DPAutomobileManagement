 ...
 * @author wy105
 */
@WebServlet(name = "DisplayItmstr", urlPatterns = {"/DisplayItmstr"})
public class DisplayItmstr extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("DPDisplayItmstr.jsp").forward(request, response);
    }
